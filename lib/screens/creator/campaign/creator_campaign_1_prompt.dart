...
class CreatorCampaignPrompt extends StatefulWidget {
  final GlobalKey<NavigatorState> navKey;

  const CreatorCampaignPrompt({
    Key? key,
    required this.navKey,
  }) : super(key: key);

  @override
  _CreatorCampaignPromptState createState() => _CreatorCampaignPromptState();
}

class _CreatorCampaignPromptState extends State<CreatorCampaignPrompt> {
  // form variables
  final _formKey = GlobalKey<FormState>();
  final TextEditingController _fullPromptController = TextEditingController();
        ...
        children: [
          ...
          Padding(
            ...
            child: CustomFormTextField(
              controller: _fullPromptController,
              placeholderText:
